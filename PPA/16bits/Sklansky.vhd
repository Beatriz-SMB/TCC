...
-- architecture
architecture behav of Sklansky is
...
begin
    ...
    -- stage 3:
    P64 <= P(6) and P54;
    G64 <= (P(6) and G54) or G(6);

    P74 <= P76 and P54;
    G74 <= (P76 and G54) or G76;

    P1008 <= P(10) and P98;
    G1008 <= (P(10) and G98) or G(10);

    P1108 <= P1110 and P98;
    G1108 <= (P1110 and G98) or G1110;

    P1412 <= P(14) and P1312;
    G1412 <= (P(14) and G1312) or G(14);

    P1512 <= P1514 and P1312;
    G1512 <= (P1514 and G1312) or G1514;

    -- stage 4:
    P1208 <= P(12) and P1108;
    G1208 <= (P(12) and G1108) or G(12);
